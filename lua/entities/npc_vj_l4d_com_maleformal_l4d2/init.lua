...
-----------------------------------------------*/
ENT.Model = {"models/darkborn/l4d2/common/common_male_formal.mdl","models/darkborn/l4d2/common/common_male_formal.mdl","models/darkborn/l4d2/common/common_male_formal.mdl","models/darkborn/l4d2/common/common_male_formal.mdl","models/darkborn/l4d2/common/common_male_formal.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:Zombie_CustomOnInitialize()
        if self:GetModel() == "models/darkborn/l4d2/common/common_male_formal.mdl" then
